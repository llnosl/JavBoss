...
type Jav struct {
	...
	TitleZH             string          `json:"title_zh" gorm:"not null;default:''"`
	TitleZHSourceHash   string          `json:"-" gorm:"not null;default:''"`
	TitleZHTranslatedAt *time.Time      `json:"title_zh_translated_at,omitempty"`
